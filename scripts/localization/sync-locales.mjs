...
function ensureFrontmatterValue(block, key, value, { overwrite = true } = {}) {
...
async function ensureTargetFrontmatter(filePath, partnerSlug, title) {
  try {
...
function ensureManifestEntry(manifest, normalizedSlug, relativePath) {
  let mutated = false
