...
import { LocaleManifest } from './types';
...
function buildPlaceholderContent(relativePath: string, manifest: LocaleManifest): string {
...
async function mirror(manifest: LocaleManifest) {
  ...
  for (const sourceFile of files) {
    ...
    try {
      ...
      // Target exists; skip and leave for human translators.
      continue;
    } catch {
