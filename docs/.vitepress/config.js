...
const nav = [{
    text: '业务设计', link: baseURI + '/product/start/index', activeMatch: '^/zh/' + version + '/(product)/'
}, // {
    //     text: '使用手册',
...
export const sidebar = {
    '/zh/v1/manual': [{
        text: '开始',
        items: [{text: '概述', link: baseURI + '/manual/start/index'}, {
            text: '安装',
            link: baseURI + '/manual/start/installation'
        }, {text: '安装配置', link: baseURI + '/manual/start/common'}, {
            text: '快速开始',
            link: baseURI + '/manual/start/quick-start'
        }, {text: 'Q&A', link: baseURI + '/manual/start/qa'}]
    }, {
        text: 'SCRM基础功能',
        items: [{text: '入门', link: baseURI + '/manual/scrm/index'}, {
            text: '渠道活码',
            link: baseURI + '/manual/scrm/contact-way'
        }, {text: '客户群发', link: baseURI + '/manual/scrm/send-group-message'}, {
            text: '客户群群发',
            link: baseURI + '/manual/scrm/send-group-chat-message'
        }, {text: '客域管理', link: baseURI + '/manual/scrm/customer'}, {
            text: '客户标签',
            link: baseURI + '/manual/scrm/customer-tag'
        }, {text: '客户迁移', link: baseURI + '/manual/scrm/customer-migrate'}, {
            text: '标签治理',
            link: baseURI + '/manual/scrm/tag'
            ...
            text: '权限管理',
            link: baseURI + '/manual/scrm/setting-permission'
        }, {text: '菜单配置', link: baseURI + '/manual/scrm/setting-menu'}]
    }], '/zh/v1/product': [{
        text: '前言',
        items: [{text: '写作初衷', link: baseURI + '/product/forward/intention'}, {
            text: '背后故事',
            link: baseURI + '/product/forward/story'
        }]
    }, {
        ...
        items: [{text: '方案概述', link: baseURI + '/product/solution/overview'}, {
            ...
            items: [{
                ...
                text: '提升业绩',
                link: baseURI + '/product/solution/product-value/improve-performance'
            },]
        ...
        items: [{text: '导读', link: baseURI + '/product/design/index'}, {
            ...
            items: [
                {text: '系统', link: baseURI + '/product/design/prd/infoStructure/system'},
                {text: '客域', link: baseURI + '/product/design/prd/infoStructure/customer'},
                {text: '市场', link: baseURI + '/product/design/prd/infoStructure/marketing'},
                {text: '商务', link: baseURI + '/product/design/prd/infoStructure/business'},
                {text: '交易', link: baseURI + '/product/design/prd/infoStructure/trade'},
                {
                    ...
                    collapsed: false,
                    items: [
                        {text: '授权登录自建线索', link: baseURI + '/product/design/prd/infoStructure/useCase/leadCreatedByLogin'},
                        {text: '客户主动咨询', link: baseURI + '/product/design/prd/infoStructure/useCase/oppCreatedByCustomer'},
        ...
        text: '产品管理',
        collapsible: true,
        items: [{text: '需求管理', link: baseURI + '/product/scrm/user'}, {
            text: '目标管理',
            link: baseURI + '/product/scrm/user'
        },]
    }]
}
