...
- [ ] T004 Create docs/website/ skeleton (index.md placeholders, public/, _mount/) per architecture in docs/design/render-site-reorg.md
- [ ] T005 Update docs/.vitepress/config.mts to use `srcDir: 'website'` and adjust `publicDir`/nav defaults
- [ ] T006 Ensure docs build scripts in package.json (`docs:dev`, `docs:build`, `docs:preview`) still target docs/ after srcDir change
